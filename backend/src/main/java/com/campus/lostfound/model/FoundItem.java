...
/**
 * Found item entity stored in the found_items MongoDB collection.
 */
public class FoundItem {
    ...
    public FoundItem(JsonObject json) {
        ...
        this.foundAt = json.getString("foundAt");
    ...
    public JsonObject toJson() {
        ...
        if (foundAt != null) json.put("foundAt", foundAt);
